...
%%
plot_bubbles(SDW_data)
plot_bubbles(CROSS_data)
%% find FWHM - SDW
...
for i = 1 : size(SDW_FWHM, 2)
    SDW_data(i).fwhm1 = px(SDW_FWHM(i).bub1(2)) - px(SDW_FWHM(i).bub1(1));
    SDW_data(i).fwhm2 = px(SDW_FWHM(i).bub2(2)) - px(SDW_FWHM(i).bub2(1));
    SDW_data(i).fwhm3 = px(SDW_FWHM(i).bub3(2)) - px(SDW_FWHM(i).bub3(1));
end
